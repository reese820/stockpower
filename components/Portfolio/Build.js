...
const rows = [
  { id: 'Stock Name', numeric: false, disablePadding: true, label: 'Stock Name' },
  { id: 'Stock Symbol', numeric: true, disablePadding: false, label: 'Stock Symbol' },
  { id: 'Closing Price', numeric: true, disablePadding: false, label: 'Closing Price' },
  { id: 'Opening Price', numeric: true, disablePadding: false, label: 'Opening Price' },
  { id: 'Dividend Yield', numeric: true, disablePadding: false, label: 'Divident Yield' },
  { id: 'Dividend Amount', numeric: true, disablePadding: false, label: 'Divident Amount' },
];
...
class Build extends React.Component {
  state = {
    ...
    selected: [],
    data: [
      createData({stockName}, {stockSymbol}, {closingPrice}, {openingPrice}, {divYield}, {divAmount}),
      createData({stockName}, {stockSymbol}, {closingPrice}, {openingPrice}, {divYield}, {divAmount}),
      createData({stockName}, {stockSymbol}, {closingPrice}, {openingPrice}, {divYield}, {divAmount}),
      createData({stockName}, {stockSymbol}, {closingPrice}, {openingPrice}, {divYield}, {divAmount}),
      createData({stockName}, {stockSymbol}, {closingPrice}, {openingPrice}, {divYield}, {divAmount}),
